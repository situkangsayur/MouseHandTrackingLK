...
// Constructor
QHistogramWidget::QHistogramWidget(QWidget *parent) : QWidget(parent) {
...
QHistogramWidget::~QHistogramWidget(void) {
    
}

void QHistogramWidget::putImage(IplImage *cvimage) {
    ...
    switch (cvimage->depth) {
        case IPL_DEPTH_8U:
            ...
            break;
        default:
            printf("This type of IplImage is not implemented in QHistogramWidget\n");
            break;
    }
    imagelabel->setPixmap(QPixmap::fromImage(image));    
}
